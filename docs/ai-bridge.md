...
| `render_flight_video` | Render a photoreal 3D multi-camera MP4 of the launch — uses Blender (real rocket model) if installed, else a built-in software renderer (needs ffmpeg) |
